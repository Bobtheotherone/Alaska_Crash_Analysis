# Alaska Car Crash Analysis — application platform (Iteration III)

> This document describes the **secure Django + React crash-analysis platform**
> (project Iterations I–III). It was formerly the repository's root README and is
> preserved unchanged in substance. The repository's root [README](../README.md)
> now presents the whole project, including the Iteration IV governed research
> portfolio under [`remediation/`](../remediation/README.md). The platform is
> archived scope: it is *not* part of the research claims, is not
> production-hardened, and its local-dev defaults are disclosed in
> `remediation/research/ISSUE_DISPOSITION_CURRENT.md` (SEC-LEGACY-001).
